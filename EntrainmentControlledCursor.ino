...
//
//A Blue Smirf RN-42 was used, as well was the OpenBCI cyton board. An arduino leonoardo was used to flash an LED at varrying frequencies and brightness
//
//WHAT DOES IT DO
...
//  - Reffer to OpenBCI documentation for any more information on how to flash the 32-board: http://docs.openbci.com
//
//CREDITS
...
//   This sketch uses Biquad filter library, which was originally devloped by: http://www.earlevel.com/main/2012/11/26/biquad-c-source-code/
//   The method of calucalting the Alpha power was adapted from Chip Audette's older method for the 8-bit board.: https://github.com/chipaudette/EEGHacker/blob/master/Arduino/OBCI_V2_AlphaDetector/
//------------------------------------------------------------------------------
//OpenBCI
#include <DSPI.h>
#include <EEPROM.h>
