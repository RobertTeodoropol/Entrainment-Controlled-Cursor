//Developed by Robert Teodoropol, group 7, capstone (2016-2017) for The Neil Squire Society http://www.neilsquire.ca/ . The following is the code used for an entrainment controlled cursor developed by group 7 in their 2016-2017 capstone for the NeilSquireSociety. It was developed for the 32-bit OpenBCI cyton board in arduino 1.6.5. All libraries used are included in the library folder, additionally, links to the original sources are provided in below Cursor.
//
...
//
//WHAT DOES IT DO This sketch will stream data from Channel #1 only
//
...
//
//DEPENDENCIES Arduino 1.6.5 was used. In order to make it work, you have to:
//
...
//
//Tip: To simulate real-life measurements, an OpenBCI input channel was put in a breadboard across the divide from a flashing LED.
//     Although there should be no connection from this flashing LED to an input channel (due to it being on the other side of the divide), 
//     a small signal similar to a real-life measured value was detected using analogWrite(32);. 
